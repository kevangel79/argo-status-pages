...
const STATUS: StatusT = {
  ...
  "Warning": { icon: "triangle-exclamation", text: Status["WARNING"], color: "#f39c12" },
  "Critical": { icon: "circle-minus", text: Status["CRITICAL"], color: "#c0392b" },
  "Unknown": { icon: "circle-question", text: Status["UNKNOWN"], color: "#95a5a6" },
};
